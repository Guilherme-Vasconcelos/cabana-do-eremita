...
Os conteúdos originais criados por mim neste projeto (textos, imagens, etc.) estão sob a licença Creative Commons Zero v1.0 Universal ("CC0 v1.0 Universal"). Isso significa que o uso desses materiais **é permitido para quaisquer finalidades sem qualquer tipo de restrição ou obrigação adicional**. Veja mais sobre a licença [aqui](https://creativecommons.org/publicdomain/zero/1.0/deed.pt-br).
